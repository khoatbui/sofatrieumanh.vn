<template>
  <div class="productlist__component">
    <div class="row m-0 p-0 category__component w-100 p-0 m-0 section__margin">
      <div
        class="col-12 col-md-10 mx-auto m-0 p-0 d-flex justify-content-center align-items-center flex-column"
      >
    ...
    <div class="row m-0 p-0">
      <div class="col-0 col-md-4 col-lg-3 m-0 p-0 filter__component px-2">
        ...
        <div class="filter__sidebar mt-4">
          ...
          <b-collapse id="collapse-filter" visible class="filter__body m-0 p-0">
            <b-card class="border-0">
